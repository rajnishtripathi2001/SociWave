          ...
          <div className="box">
            ...
            <div className="wallet-item" >
              <div className="text-part">
                ...
                <h4>$0.00</h4>
                <p>
                  Your total spendings : <span>$0.00</span>
                </p>
              </div>
          ...
          <div className="order-section box">
            <MDBTabs className="mb-3">
              ...
              <MDBTabsItem>
                ...
                >
                  <MDBIcon fas icon="th-large" className="me-2" />{" "}
                  Bulk Service
                </MDBTabsLink>
              </MDBTabsItem>
            </MDBTabs>
            ...
            <MDBTabsContent style={{ width:"100%"}}>
              <MDBTabsPane show={iconsActive === "tab1"} >
                <b>Services</b>
                <select id="services" name="services" className="qwety" value={service} onChange={(e)=>setService(e.target.value)}>
                ...
                <b>Package</b> 
                <select id="package" name="package" className="qwety" onChange={(e)=>setPrice(parseFloat(e.target.value + ".00") )} >
                  {
                    packages.map((pack)=>{
                ...
                <b>Link</b>
                <input type="text" placeholder="Account Must be Public" className="qwety" name="link" id="link" />
              ...
              <MDBTabsPane show={iconsActive === "tab2"}>Very Soon</MDBTabsPane>
            </MDBTabsContent>
          </div>
